import cc398OpenClosedImage from "../assets/Howard_Core_CC398_Violin_Case_Open_Closed.png";
...
import bobelockB1051OpenClosedImage from "../assets/Bobelock_B1051_Corregidor_Violin_Case_Open_Closed.png";
import bobelockB1051OpenImage from "../assets/Bobelock_B1051_Corregidor_Violin_Case_Open.png";
import bobelockB1051ClosedImage from "../assets/Bobelock_B1051_Corregidor_Violin_Case_Closed.png";
...
import bam2002XLClosedImage from "../assets/Bam_2002XL_Hightech_Violin_Case_Closed.png";
import bam2002XLOpenImage from "../assets/Bam_2002XL_Hightech_Violin_Case_Open.png";
...
import bobelockB2001OpenClosedImage from "../assets/Bobelock_2001_Viola_Case_Open_Closed.png";
...
import bobelockB2005OpenClosedImage from "../assets/Bobelock_B2005_Viola_Case_Open_Closed.png";
...
export const cases = [
...

  {
    ...
    slug:
      "howard-core-cc398-violin-case",

    name:
      "Howard Core CC398 - Core Economy Model Oblong Violin Case",

    maker:
      "Howard Core",

    model:
      "CC398 Core Economy Model",
    ...
    descriptionParagraphs: [
      ...
      "Engineered for reliability and convenience, the CC398 features two Hill-style bow holders, accessory storage, and an included hygrometer for monitoring humidity—essential for maintaining your instrument’s condition. The full-length exterior music pocket provides ample space for sheet music and accessories, making it a practical choice for students and advancing players alike.",
    ...
    exterior:
      "Cordura screw-attached cover with latch flap",
    ...
    protection:
      "Foam shell with plush-lined suspension support",
  ...
  /* =====================================================
     BOBELOCK B1051 CORREGIDOR PROFESSIONAL
     OBLONG VIOLIN CASE
  ====================================================== */

  {
    id:
      "bobelock-b1051-corregidor",

    slug:
      "bobelock-b1051-corregidor-violin-case",

    name:
      "Bobelock B1051 Corregidor Professional Oblong Violin Case",

    maker:
      "Bobelock",

    model:
      "B1051 Corregidor Professional",
    ...
    closedImage:
      bobelockB1051ClosedImage,

    openImage:
      bobelockB1051OpenImage,
    ...
    descriptionParagraphs: [
      ...
      "Inside, the full French-fitted velvet interior creates a refined, supportive environment for the 4/4 violin. The redesigned slanted interior improves shock resistance while increasing usable storage space. A large pocket near the scroll and two square pockets along the neck provide organized accessory storage, while four patented bow holder mechanisms keep multiple bows secure.",

      "Instrument care features include a hygrometer, humistat, quilted case floor, instrument blanket, satin instrument bag, and string tube. The carefully fitted interior and suspension construction are designed to provide the security expected by professional musicians, collectors, and players transporting valuable instruments.",

      "The exterior is finished in durable black nylon canvas with a zippered screw-attached cover, brass hardware, trim detailing, and a generous outside music pocket. An organizer within the music pocket provides space for pencils, a metronome, notebooks, and other essentials.",
    ...
    keyFeatures: [
      {
        ...
        description:
          "Five layers of reinforced plywood create a strong professional shell designed for excellent stability and shock protection.",
      },

      {
        title:
          "Full French-Fitted Interior",

        icon:
          "interior",

        description:
          "A luxurious velvet full French-fit interior uses a slanted redesign to improve shock protection while increasing interior storage.",
      },

      {
        title:
          "Four Patented Bow Holders",

        icon:
          "storage",

        description:
          "Four unique patented bow holder mechanisms provide secure dedicated storage for multiple full-size violin bows.",
      },

      {
        ...
        description:
          "A hygrometer, humistat, quilted floor, instrument blanket, satin instrument bag, and string tube support proper instrument care.",
      },

      {
        ...
        description:
          "A large exterior music pocket, interior accessory pockets, and built-in organizer provide extensive storage for music and accessories.",
      },

      {
        title:
          "Elegant Professional Transport",

        icon:
          "transport",

        description:
          "A leather handle, included shoulder strap, brass hardware, and center D-ring provide refined and practical carrying options.",
      },
    ],
    ...
    shell:
      "Five-layer reinforced plywood",

    construction:
      "Five-layer plywood construction in a continental oblong Hill-style shape",

    exterior:
      "Black nylon canvas screw-attached zippered cover with brass fittings and trim detailing",

    interior:
      "Velvet full French-fitted suspension interior with slanted redesign for improved shock protection and storage",

    bowCapacity:
      "4 patented bow holder mechanisms",

    musicPocket:
      "Large exterior music pocket with pencil, metronome, and notebook organizer",

    closure:
      "Zippered canvas cover with brass hardware",

    carrying:
      "Leather handle, included shoulder strap, and center D-ring for optional backpack straps",

    extraFeatures:
      "Large scroll-end pocket, 2 square neck pockets, string tube, quilted case floor and blanket, hygrometer, humistat, satin instrument bag, and backpack-strap D-ring",

    color:
      "Blue, Green, Wine, Smokey Red",
    ...
    insideFeatures: [
      ...
      "Velvet interior.",
      "Full French fit.",
      "Slanted interior design for increased shock protection and additional storage.",
      "One large pocket at the end of the scroll.",
      "Two square pockets along the neck.",
      "Four patented bow holder mechanisms.",
      "String tube.",
      "Quilted case floor and instrument blanket.",
      "Hygrometer and humistat.",
      "Satin instrument bag.",
    ],

    outsideFeatures: [
      "Continental oblong Hill-style shape.",
      "Five-layer plywood construction.",
      "Black nylon canvas screw-attached zippered cover.",
      "Large exterior music pocket.",
      "Pencil, metronome, and notebook organizer enclosed in the music pocket.",
      "Leather handle.",
      "Included shoulder strap.",
      "Center D-ring for optional backpack straps; backpack straps sold separately.",
      "Brass hardware.",
      "Trim detailing.",
    ],
...

  {
    ...
    slug:
      "bam-2002xl-hightech-violin-case",
    ...
    caseStyle:
      "Hightech contoured violin case",
    ...
    descriptionParagraphs: [
      ...
      "Inside, the violin is fully suspended on premium velvet fabric-covered injected foam cushions for enhanced protection and instrument care. A Velcro neck strap helps keep the instrument securely positioned, while the interior provides storage for two full-size bows, a removable accessory zipper pouch, and a secure Velcro strap for a Kun-style shoulder rest.",

      "The exterior combines protection with practical travel features, including an ergonomic side handle, detachable subway handle, two BAM Series 2 soft-touch latches with included keys, and a male/female airtight H seal. Anti-slip and anti-wear rubber patches help protect the case exterior while preventing unwanted sliding.",
    ...
    keyFeatures: [
...

      {
        ...
        description:
          "Premium velvet-covered injected foam cushions fully suspend the violin, with a Velcro neck strap providing additional instrument security.",
      },
...

      {
        ...
        description:
          "A removable zipper pouch and secure Velcro strap provide organized storage for accessories and a Kun-style shoulder rest.",
      },
...

      {
        ...
        description:
          "At 3 lbs. 14 oz., the case combines an ergonomic side handle, detachable subway handle, and neoprene backpack straps for comfortable travel.",
      },
    ],
    ...
    exterior:
      "Contoured Hightech ABS shell with anti-slip and anti-wear rubber patches",

    interior:
      "Premium velvet fabric-covered injected foam cushions with full suspension support and Velcro neck strap",
    ...
    extraFeatures:
      "Removable accessory zipper pouch, secure Velcro strap for a Kun-style shoulder rest, and covered security screw carabiner hooks",
...

  {
    ...
    slug:
      "bobelock-b2005-featherlite-viola-case",
    ...
    closedImage:
      bobelockB2005ClosedImage,

    openImage:
      bobelockB2005Open1Image,
    ...
    descriptionParagraphs: [
      ...
      "The Featherlite shell uses a combination of layered plywood and styrofoam, reinforced with fiberboard and plywood, and is covered with a durable black nylon canvas zippered cover. A full exterior music pocket, rain flap, pencil pocket, shoulder strap, and subway strap make the case practical for lessons, rehearsals, performances, and regular travel.",

      "Inside, the B2005 features full suspension with a semi-French fit, two interior accessory pockets, four bow holders, a string tube, instrument blanket, Velcro neck restraint, and tail-block sponge. A hygrometer and humistat are also included for instrument-care monitoring.",
    ...
    shell:
      "Layered plywood and styrofoam Featherlite shell reinforced with fiberboard and plywood",

    construction:
      "Traditional oblong Featherlite construction using layered plywood and styrofoam with Bobelock’s patented adjustable slide",

    exterior:
      "Durable black nylon canvas screw-attached zippered cover with rain flap and full exterior music pocket",

    interior:
      "Full-suspension semi-French fit interior with adjustable slide",
    ...
    closure:
      "Zippered black nylon canvas cover with rain flap",

    carrying:
      "Shoulder strap and subway strap",

    extraFeatures:
      "2 interior accessory pockets, pencil pocket, string tube, instrument blanket, hygrometer, humistat, Velcro neck restraint, and tail-block sponge",

    color:
      "Velour: Blue, Wine, Gray, Green, Tan; Velvet: Blue, Wine, Gray, Green",
    ...
    insideFeatures: [
      "Full suspension.",
      "Semi-French fit.",
      "Patented adjustable slide fits violas from 15 inches to 17 inches.",
      "Four bow holders.",
    ...
    outsideFeatures: [
      ...
      "Fiberboard and plywood reinforcement.",
      "Durable black nylon canvas screw-attached zippered cover.",
      "Rain flap.",
      "Full exterior music pocket.",
      "Pencil pocket.",
      "Shoulder strap.",
...

  {
    ...
    closedImage:
      bobelockB2001ClosedImage,

    openImage:
      bobelockB2001OpenImage,
    ...
    descriptionParagraphs: [
      ...
      "Engineered for maximum protection and portability, the B2001 balances strength and lightness. The suspension interior cushions your viola against bumps and impacts, while the included instrument blanket adds an extra layer of safety. Its plush interior and solid exterior ensure that your viola stays secure during transport, whether commuting to lessons, performances, or rehearsals.",
    ...
    construction:
      "Five-layer plywood shaped suspension construction",

    exterior:
      "Black nylon canvas with zippered cover and small exterior accessory pocket",

    interior:
      "Plush velour lining with suspension",
    ...
    extraFeatures:
      "Instrument blanket and small exterior accessory pocket",

    color:
      "Green, Blue, Gray, Wine, Tan",
